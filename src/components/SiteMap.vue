<template>
  <div class="site-map">
    <SiteHeader activeText="map"/>
    <div class="info-container">
      <div class="big-title">
        Please select from the following:<br>
        <div class="section-wrapper"
          v-for="(section, index) in sections" :key="index">
          <FancyBox :info="section" class="section-box"/>
        </div>
      </div>
    </div>
  </div>
...
import FancyBox from '../parts/FancyBox.vue';
import siteMaps from '../data/siteMap';
